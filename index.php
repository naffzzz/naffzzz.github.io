      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample11" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="mx-auto d-sm-flex d-block flex-sm-nowrap">
            <div class="collapse navbar-collapse text-center" id="navbarsExample11">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="biographyBtn">Biography</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="educationBtn">Education</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="awardsBtn">Awards</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="contactMeBtn">Contact Me</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
      ...
      <div class="row text-center mb-5 reveal slideInFromBottom">
        <div class="col bg-white">
          ...
          <div class="d-flex justify-content-between">
            <div>
              <span><i class="fa-solid fa-user-tie text-success"></i> Intern Employee</span>
            </div>
            <div>
      ...
      <div class="row text-justify mb-5 reveal slideInFromBottom">
        <div class="col bg-white">
          <div>
            <span><strong>Web Programming:</strong> Laravel, ReactJS, CodeIgniter, Node.js, php, javascript, jQuery, AngularJS, Materialize, FontAwesome, Bootstrap, DotNet, GoLang</span>
          </div>
          <hr>
          <div>
            <span><strong>Research Programming:</strong> Python</span>
          </div>
          <hr>
          <div>
            <span><strong>Game Programming:</strong> C#</span>
          </div>
          <hr>
          <div>
      ...
      <div class="row text-justify mb-5 reveal slideInFromBottom">
        <div class="col bg-white">
          ...
          <div>
              <span><strong>Nafa Zulfa</strong>, Nanik Suciati, Shintami Chusnul Hidayati,</span>
              <span>"Improved Lip-reading Language using Gated Recurrent Units"</span>
